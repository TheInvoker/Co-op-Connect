var CHECKLIST_MODULE = {
	...
	formatChecklist : function(obj) {
		var str = '<table>';
		str += '<tr><td title="Name" valign="top"><span class="ui-icon-arrow-r ui-btn-icon-left myicon"/></td><td valign="top" class="mywrap">' + obj['name'] + '</td></tr>';
		str += '<tr><td title="Description" valign="top"><span class="ui-icon-info ui-btn-icon-left myicon"/></td><td valign="top" class="mywrap">' + obj['description'] + '</td></tr>';
		str += '<tr><td title="Last Updated" valign="top"><span class="ui-icon-calendar ui-btn-icon-left myicon"/></td><td valign="top" class="mywrap">Updated: ' + obj['last_updated'] + '</td></tr>';
		str += '</table>';
		return str;
	},
